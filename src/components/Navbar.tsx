...
export function Navbar() {
    return (
        <header className="sticky top-0 inset-x-0 z-50 bg-transparent max-sm:pt-6 max-sm:px-6">
            <nav className="w-full flex items-center justify-between px-6 py-4 max-sm:p-2 max-sm:bg-navbar-blur max-sm:backdrop-blur-md max-sm:backdrop-saturate-150 max-sm:border max-sm:border-white/20 max-sm:gap-10 rounded-full shadow-[0_8px_24px_rgba(0,0,0,0.25)] max-sm:h-12 max-sm:rounded-[12px]">
                <Link href="/" className="text-xl font-bold">
                    <Image src="/logo.svg" width={120} height={40} alt="Sigma" />
                </Link>
