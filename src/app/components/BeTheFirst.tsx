...
export const BeTheFirst = () => {
    return (
        <section className="mt-40 flex flex-col items-center justify-center relative border-t border-t-[#FFFFFF26] border-b border-b-[#FFFFFF26] h-[473px] max-sm:h-[299px]">
            ...
            <div className="w-1/4 group box-border mt-6 max-sm:mt-10 max-sm:w-[85%] relative flex items-center gap-2 rounded-sm border bg-[#141414] border-[#292929] focus-within:ring-2 focus-within:ring-white/10 h-12">
                ...
                <button className="flex items-center justify-center bg-white m-1 max-sm:m-2 h-[41px] max-sm:h-8 px-4 whitespace-nowrap font-medium text-sm rounded-[2px] max-sm:rounded-sm cursor-pointer">Join us</button>
            </div>
